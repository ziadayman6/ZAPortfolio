...
function ThirdSection() {
  ...
  const projects = [
    ...
    },
    {
      id: 5,
      title: "CRUD WEBSITE",
      desc: `A CRUD web app with centralized state management using Redux, featuring add, edit, delete, and view operations on dummy data with a clean, responsive UI. \n I used ReactJS library with Typescript language, Tailwindcss for styling and dark mode, i18next library for multi language, Redux for state management, React Hook Form library for managing forms in add and edit methods , and finally React Router for navigation. `,
      image: "imgs/crud.png",
      url: "https://cds-crud-site.netlify.app/",
      code: "https://github.com/ziadayman6/CRUDsite",
      tools: [
